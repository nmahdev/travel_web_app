          ...
          <Row>
            ...
            <Col md="3" sm="12" className="location mt-3 mt-md-0 ">
              ...
              <i class="bi bi-envelope me-3"></i>
                <a target="_blank" href="mailto:nguyenmanh.developer@gmail.com" className="d-block" >nguyenmanh.developer@gmail.com</a>
              </div>
              <div className="d-flex align-items-top ">
                <i className="bi bi-telephone me-3"></i>
                <a target="_blank" href="tel:+84396468242" className="d-block" >+84 396 468 242</a>
              </div>
